...
/*↑步驟一顯示svg板型*/
	...
	$('.step1_maxContent .board').click(function(){
		if($('.step1_maxContent .board').eq(0).hasClass('click')){
			...
			// funboard
			boardshape='<path d="M121.6,302.9c-0.5-113.2-46.5-167.9-46.5-167.9s-45.9,54.8-46.4,167.9S48,462.2,58.1,484c0,0,6.7,4.5,17,4.5 s16.7-3.9,17-4.5C92.5,483.4,122.1,416,121.6,302.9z"/>';
 			setsvgboard(boardshape);
