...
function First(){
    ...
    $(".customize-order-btn").click(function(){
        ...
        // var ODImg = $(this).parent().parent().next().children('input').eq(3).val();

        var ODTel = $(this).parent().parent().next().children('input').eq(4).val();
        var ODEmail = $(this).parent().parent().next().children('input').eq(5).val();
        var ODAdress = $(this).parent().parent().next().children('input').eq(6).val();
        var ODAtm = $(this).parent().parent().next().children('input').eq(7).val();
        var ODMessage = $(this).parent().parent().next().children('input').eq(8).val();
        // console.log(ODTel);
        // console.log(ODDate);
        // console.log(ODTotal);
